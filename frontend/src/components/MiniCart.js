        ...
        <div className="relative">
            ...
            {isOpen && (
                <div className="absolute right-0 mt-2 w-72 bg-gray-800 rounded-md shadow-lg z-10 border border-gray-700">
                    <div className="p-4">
                        <h3 className="text-lg font-semibold mb-2 text-white">Your Cart</h3>
                        {cart.length === 0 ? (
                            <p className="text-gray-300">Your cart is empty</p>
                        ) : (
                            <>
                                {cart.map((item) => (
                                    <div key={item._id} className="flex items-center justify-between mb-3 pb-3 border-b border-gray-700">
                                        <div>
                                ...
                                <div className="mt-4">
                                    <p className="font-semibold text-white">Total: ${total.toFixed(2)}</p>
                                </div>
